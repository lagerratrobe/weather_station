...
stations <- c('KTXHOUST3150', 'KTXDALLA724', 'KWASEATT2743', 'KWASEQUI431', 'ISTROU34', 'IWESTMOU2', 'KNYALBAN124', 'KTNANTIO26', 'KTXDALLA872', 'KTXHOUST3329', 'KCAALAME63', 'KVAROANO253')
